# Commercial and licensing readiness

This is the evidence checklist for Phase 13. Drafts and automation may be prepared early, but no unchecked legal item may be represented as approved.
...
- [ ] Approved license-policy exceptions record component, version, context, approver, owner, and review trigger.

## Managed hosting and support

- [ ] Hosting scope, regions, retention, deletion, backups, and availability target are approved.
- [ ] Pricing and billing units are validated using measured infrastructure and support costs.
- [ ] Support channels, hours, severities, response targets, escalation, and status communication are staffed.
- [ ] Website terms, privacy policy, DPA, subprocessors, AUP, support policy, SLA, order form, and security materials are approved.
- [ ] Tax, invoicing, refunds, renewals, cancellation, and failed-payment handling are operational.
- [ ] One non-production purchase-to-cancellation-and-export journey is rehearsed and recorded.

## Evidence policy

Evidence must identify the exact document version, software revision, artifact digest, approver, and date. Scanner output is evidence for review, not legal approval. Phase 13 remains incomplete until the Phase 13 success criteria and predecessor release gates pass.
